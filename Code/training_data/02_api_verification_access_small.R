...
pre_accessed <- read.csv("Data/API_verification_sample_small.csv")
...
write.csv(x = tmp, file = "Data/API_verification_sample_full.csv", row.names = FALSE)
